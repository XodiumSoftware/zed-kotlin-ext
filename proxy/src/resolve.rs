...
mod tests {
    ...
    fn strips_file_scheme() {
        assert_eq!(
            uri_to_path("file:///opt/jdk/lib/src.zip"),
            "/opt/jdk/lib/src.zip"
        );
    }
    ...
    fn strips_windows_drive_letter() {
        // Windows URI paths carry a leading slash before the drive letter (`/C:/...`).
        assert_eq!(
            uri_to_path("file:///C:/opt/jdk/lib/src.zip"),
            "C:/opt/jdk/lib/src.zip"
        );
    }
    ...
    fn strips_jar_scheme() {
        ...
        assert_eq!(
            uri_to_path("jar:///opt/jdk/lib/src.zip"),
            "/opt/jdk/lib/src.zip"
        );
    }
